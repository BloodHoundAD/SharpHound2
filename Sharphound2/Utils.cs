...
namespace Sharphound2
{
    class Utils
    {
        ...
        public SearchResponse GetSimpleSearcher(string Filter, string[] Attribs, out LdapConnection connection, string DomainName = null, string ADSPath = null, string DomainController = null)
        {
            Domain TargetDomain;
            try
            {
            ...
            connection = new LdapConnection(new LdapDirectoryIdentifier(DomainController));
        ...
        public SearchResponse GetSingleSearcher(string Filter, string[] Attribs, out LdapConnection connection, string DomainName = null, string ADSPath = null, string DomainController = null)
        {
            Domain TargetDomain;
            try
            {
